...
- DB schema: `lib/db/src/schema/*.ts` (tables: candidates, candidate_positions, candidate_records, candidate_record_enrichment, candidate_issue_summaries, candidate_donor_categories, candidate_donor_signals, candidate_vote_signals, issues, questions, voters, voter_answers, voter_stances, sync_meta)
